...
Esta página es un proyecto personal, se trata de un formulario de registro de pacientes de una veterinaria almacenado en localStorage. Proyecto elaborado con React TypeScript, TailwindCSS y Zustand.
...
¡Gracias por visitar el repositorio de Registro Pacientes Veterinaria!
